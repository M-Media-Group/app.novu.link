...
const HTMLSupportedInputElementStringForQuerySelector = supportedElements
  .filter((element) => element !== HTMLFormElement && element !== HTMLFieldSetElement)
...
export const useForm = (formElement: Ref<HTMLFormElement | null>) => {
  ...
  return {
    ...
    setSuccessOnInput,
    removeSuccessOnInputs: () => formElement.value ? removeSuccessOnInputs(formElement.value) : undefined,
    removeSuccessOnInput,
    resetCustomValidityOnInput,
    resetCustomValidityOnInputs: () =>
      formElement.value ? resetCustomValidityOnInputs(formElement.value) : undefined,
    checkValidity: () => formElement.value ? checkValidity(formElement.value) : undefined,
    handleInput,
    focusOnFirstInput: () => formElement.value ? focusOnFirstInput(formElement.value) : undefined,
    focusOnFirstEmptyInput: () => formElement.value ? focusOnFirstEmptyInput(formElement.value) : undefined,
    isElementInFocus,
